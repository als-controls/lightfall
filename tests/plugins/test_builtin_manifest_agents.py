"""Verify the builtin manifest exposes 12 agent entries (no skill/mcp_tool entries)."""
from __future__ import annotations


def test_manifest_has_12_agent_entries_and_no_skill_or_mcp_tool_entries():
...
def test_manifest_lists_expected_agent_names():
    ...
    assert agent_names == {
        ...
        "lightfall_core_tools", "autonomous_experiment", "current_esaf",
    }
    # skill_docs is GONE
