...
class TestEnginePlugin:
    ...
    def test_bluesky_plugin_properties(self) -> None:
        ...
        from ncs.acquire.engine.plugins import BlueskyEnginePlugin
    ...
    def test_mock_plugin_properties(self) -> None:
        ...
        from ncs.acquire.engine.plugins import MockEnginePlugin
    ...
    def test_bluesky_plugin_creates_engine(self, qapp) -> None:
        ...
        from ncs.acquire.engine.plugins import BlueskyEnginePlugin
        from ncs.acquire.engine import BlueskyEngine
    ...
    def test_mock_plugin_creates_engine(self, qapp) -> None:
        ...
        from ncs.acquire.engine.plugins import MockEnginePlugin
        from ncs.acquire.engine import MockEngine
...
class TestEngineRegistry:
    ...
    def test_register_multiple_engines(self, engine_registry) -> None:
        ...
        from ncs.acquire.engine.plugins import BlueskyEnginePlugin, MockEnginePlugin
...
class TestGetEngineWithPlugins:
    ...
    def reset_engine(self):
        ...
        from ncs.acquire.engine import reset_engine
        from ncs.acquire.engine.registry import EngineRegistry
    ...
    def test_get_engine_with_registered_plugin(self, qapp) -> None:
        ...
        from ncs.acquire.engine import get_engine, reset_engine, MockEngine
        from ncs.acquire.engine.registry import EngineRegistry
        from ncs.acquire.engine.plugins import MockEnginePlugin
    ...
    def test_get_engine_fallback(self, qapp) -> None:
        ...
        from ncs.acquire.engine import get_engine, MockEngine
    ...
    def test_get_engine_unknown_type(self, qapp) -> None:
        ...
        from ncs.acquire.engine import get_engine
