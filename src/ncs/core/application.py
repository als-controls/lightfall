...
class NCSEventTypes:
    ...
    CONFIG_CHANGED = NCSEvent.register_type("ncs.config.changed")
    SERVICE_REGISTERED = NCSEvent.register_type("ncs.service.registered")
    STATE_CHANGED = NCSEvent.register_type("ncs.state.changed")
