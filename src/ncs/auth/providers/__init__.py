...
from ncs.auth.providers.base import AuthProvider
from ncs.auth.providers.local import LocalAuthProvider
...
try:
    from ncs.auth.providers.keycloak import KeycloakAuthProvider
