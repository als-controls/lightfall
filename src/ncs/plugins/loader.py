...
from ncs.utils.threads import QThreadFutureIterator, invoke_in_main_thread, is_main_thread
...
class PluginLoader(QObject):
    ...
    def _register_with_type_registry(self, plugin_info: PluginInfo) -> None:
        ...
        if plugin_info.type_name == "plan":
            try:
                from ncs.acquire.plans.registry import PlanRegistry
