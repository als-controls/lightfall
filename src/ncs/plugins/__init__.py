...
Example manifest in a plugin package::
    ...
    from ncs.plugins import PluginManifest, PluginEntry
...
Entry point in pyproject.toml::
    ...
    [project.entry-points."ncs.plugins"]
...
Example plan plugin::
    ...
    from ncs.plugins import PlanPlugin
...
The plugin system is typically used via the ServiceRegistry::
    ...
    from ncs.core.services import ServiceRegistry
    from ncs.plugins import PluginRegistry, PluginLoader, PlanPlugin
