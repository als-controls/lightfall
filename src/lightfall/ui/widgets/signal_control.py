...
class SignalControlWidget(BaseControlWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self._value_display._value_label.setStyleSheet(f"""
            QLabel {{
...
class SignalRowWidget(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self._value_label._value_label.setStyleSheet(f"font-family: monospace; font-size: {scaled_pt(11)}pt;")
        ...
        if not self._writable:
            ...
            ro_label = QLabel("RO")
            ro_label.setStyleSheet(f"color: #888; font-size: {scaled_pt(9)}pt;")
