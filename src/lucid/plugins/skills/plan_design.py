...
class PlanDesignSkill(SkillPlugin):
    ...
    def get_system_prompt(self) -> str:
        ...
        return '''
## Bluesky Plan Design Expertise

You are an expert at designing Bluesky plans for LUCID. Plans are Python generators
that yield Bluesky messages to control data acquisition.
...
## LUCID UI Annotations (lucid.ui.annotations)
...
## Bluesky Plan Stubs (bluesky.plan_stubs / bps)
...
## Standard Bluesky Plans (bluesky.plans / bp)
...
## Plan Function Signature Best Practices
